...
import imggg from "../../assets/images/img3.jpg";
...
export default function CreatePost() {
  ...
  return (
    <div>
      <Modal>
        <section className="bg-[#ededed] p-4 rounded shadow  my-5">
          <div className="flex items-center space-x-3 mb">
            ...
            />
            <Button variant="secon" className="w-full bg-white">
              <input
                type="text"
                placeholder="What's on your mind?"
                className="placeholder:text-start focus:border-0   w-full outline-0 rounded p-0.5"
              />
            </Button>
          </div>
